        ...
        <div class = "content">
            ...
            <div class="col-md-12">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="Description" class="col-md-2 control-label">Description <span style="color:red">*</span></label><!--event description-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="Description" name="Description" value="<?php echoValue($formdata, "Description")?>" required /><!--input-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <select name="event_type" id="event_type" class="form-control" required>
                            ...
                            <option value="Musical Festival">Musical Festival</option>
                        </select>
                    </div>
                    <div class="form-group">
